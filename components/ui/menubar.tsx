...
function Menubar({
  ...
  return (
    <MenubarPrimitive.Root
      data-slot="menubar"
      className={cn(
        "bg-default-50 flex h-11 items-center gap-1.5 rounded-xl border-2 border-default-200 p-1.5 shadow-sm",
        className
      )}
      {...props}
    />
...
function MenubarTrigger({
  ...
  return (
    <MenubarPrimitive.Trigger
      ...
      className={cn(
        "flex items-center rounded-lg px-3 py-2 text-sm font-semibold outline-hidden select-none",
  ...
  return (
    <MenubarPortal>
      <MenubarPrimitive.Content
        ...
        className={cn(
          "bg-default-50 text-default-900 z-50 min-w-[12rem] origin-(--radix-menubar-content-transform-origin) overflow-hidden rounded-xl border-2 border-default-200 p-1.5 shadow-lg",
...
function MenubarSubTrigger({
  ...
  return (
    <MenubarPrimitive.SubTrigger
      ...
      data-inset={inset}
      className={cn(
        "flex cursor-default items-center gap-2 rounded-lg px-3 py-2 text-sm outline-none select-none",
        "transition-colors duration-150",
        "focus:bg-default-100 focus:text-default-900",
        "data-[state=open]:bg-default-100 data-[state=open]:text-default-900",
        "data-[inset]:pl-10",
...
function MenubarSubContent({
  ...
  return (
    <MenubarPrimitive.SubContent
      ...
      className={cn(
        "bg-default-50 text-default-900 z-50 min-w-[8rem] origin-(--radix-menubar-content-transform-origin) overflow-hidden rounded-xl border-2 border-default-200 p-1.5 shadow-lg",
        "data-[state=open]:animate-in data-[state=closed]:animate-out",
        "data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
        "data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95",
        "data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2",
